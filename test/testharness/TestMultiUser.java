...
public class TestMultiUser {
	...
	private UserComputingAPI coordinator;
	// Multi-threaded implementation we're testing
	private UserComputingMultiThread networkAPI;
	...
	public void initializeComputeEngine() {
		...
		networkAPI = new UserComputingMultiThread(dataStorageAPI,computationAPI);	
	...
	public void compareMultiAndSingleThreaded() throws Exception {
		...
		System.out.println("Created " +nThreads +" test users");
		...
		// Run multi threaded (all users at once)
